...
help-message =
    ...
    /language_menu Чтобы вызвать интерактивное меню для выбора языка интерфейса
...
select-language = Выбери язык, на который переключиться.
select-language-cancel = редактирование языка интерфейса отменено. Возвращаюсь к предыдущим настройкам.
select-language-save = ОК, сохраняю язык интерфейса как { $language }
